...
#         super(EFSEED, self).__init__(opt)
    ...
    def inference_test(self, x_test, y_input1):
        ...
        with torch.no_grad():
            ...
            out0, out1, out2, out3, out4 = self.decoder(y_input1, x_test, encoder_h, encoder_c)     
    ...
    def generate_single_val_rmse(self, min_RMSE=500):
        ...
        if total < min_RMSE:
            ...
            #save_model
            encoder_name = self.expr_dir + '/' + 'EFSEED_encoder.pt'
            decoder_name = self.expr_dir + '/' + 'EFSEED_decoder.pt'
