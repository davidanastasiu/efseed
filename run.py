...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--os_s', type=int, default=4, help='oversampling steps')
        self.parser.add_argument('--os_v', type=int, default=5, help='oversampling frequency')
        self.parser.add_argument('--quantile', type=int, default=85, help='quantile value')
        ...
        self.parser.add_argument('--oversampling', type=str, default=20, help='kruskal statistics threshold')        
...
#         print(opt_dic)
        ...
        for k, v in sorted(args.items()):
            ...
            elif n == "self.opt.quantile": 
                    self.opt.quantile = int(val)                    
