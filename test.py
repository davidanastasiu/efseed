...
def main():
    ...
    x_stream = np.arange(1440)
    x_ground_truth = np.arange(1440, 1440+288)
    x_predicted = np.arange(1440, 1440+288)
                        
    plt.plot(x_stream, stream_data, label='Stream Data', color='black')
