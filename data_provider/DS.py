...
class DS:
    ...
    def val_dataloader(self):
        ...
        file_name = os.path.join(val_dir, "validation_timestamps_24avg.tsv")  # unused?
        ...
        if self.is_over_sampling == 1:
            ...
            while ii < self.opt.val_size:
                ...
                if (
                    ...
                    i = (
                        self.trainX[self.trainX["datetime"] == point].index.values[0]
                        - self.start_num
                        - self.train_days
                    )
